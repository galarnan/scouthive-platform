...
function Search (props) {
  ...
  function handleChangemulti(field, evt, third) {
    ...
    .filter(player =>{
      return (player.Position.includes(filters.Positions) || !filters.Positions.length)
    })
    .filter(player =>{
...
useEffect(()=>{
  ...
  <div className="row text-start p-4">
    ...
    <div className="col-md-3">
      <input name = 'Name' onChange={handleChange} value={filters.Name} className="form-control" id="inputEmail4" placeholder="Name"/>
    </div>
